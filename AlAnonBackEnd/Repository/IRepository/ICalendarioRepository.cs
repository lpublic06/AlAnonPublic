...
namespace AlAnon.Repository.IRepository
{
    public interface ICalendarioRepository
    {
        ...
        public Task<RespuestaDto<List<CalendarioEventoDto>>> ObtenerTodosLosCalendarioEventosActuales(DateTime today);
        public Task<RespuestaDto<List<CalendarioEventoDto>>> ObtenerTodosLosCalendarioEventosPasados(DateTime today);
    }
}
